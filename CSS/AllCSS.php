...
#Banner { 
 ...
 background-image:url(/images/GOLDBLOXBannerv3.png);
...
#Banner #Alerts #GOLDBUXAlert a
{
  color: Green;
}

#Banner #Alerts #GOLDBUXAlert a:hover
{
  color: #49b745;
}
...
#MyAccountBalanceContainer #AboutGOLDBUX {
 border-bottom:solid 1px #000;
 border-left:solid 1px #000;
 border-right:solid 1px #000;
 float:right;
...
#MyAccountBalanceContainer #AboutGOLDBUX h3 {
 border-top:solid 1px #000;
}
#MyAccountBalanceContainer #AboutGOLDBUX p {
 margin:0;
 padding:10px 15px;
}
...
.SystemAlertText {
 font: normal 8pt/normal 'Arial' , Verdana, sans-serif;
 font-size:16px;
 font-weight:bold;
...
#BadgesContainer #CommunityBadges .Legend #Administrator {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Administrator-75x75.png);
}
#BadgesContainer #CommunityBadges .Legend #ForumModerator {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/ForumModerator-75x75.png);
}
#BadgesContainer #CommunityBadges .Legend #ImageModerator {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/ImageModerator-75x75.png);
}
#BadgesContainer #FriendshipBadges .Legend #Friendship {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Friendship-75x75.jpg);
}
#BadgesContainer #FriendshipBadges .Legend #Inviter {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Inviter-75x75.png);
}
#BadgesContainer #CombatBadges .Legend #CombatInitiation {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/CombatInitiation-75x75.jpg);
}
#BadgesContainer #CombatBadges .Legend #Warrior {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Warrior-75x75.jpg);
}
#BadgesContainer #CombatBadges .Legend #Bloxxer {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Bloxxer-75x75.jpg);
}
#BadgesContainer #VisitsBadges .Legend #Homestead {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Homestead-70x75.jpg);
}
#BadgesContainer #VisitsBadges .Legend #Bricksmith {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/Badges/Bricksmith-54x75.jpg);
}
...
#CatalogContainer .PriceInGOLDBUX,
#CatalogContainer .PriceInTickets,
#CatalogContainer .PriceForFree
{
  font-size: 0.8em;
}
...
#Help .descriptionPanels {
 ...
 background-image:url('/web/20090604133500im_/http://www.GOLDBLOX.com/images/Speech Bubble 225.gif');
 width:225px;
 height:235px;
 background-repeat:no-repeat;
 margin-top:40px;
...
#Help .forumLinks {
 ...
 opacity:.93;
 background-color:#eee;
 background-image:url('/web/20090604133500im_/http://www.GOLDBLOX.com/images/help_gradient.png');
...
#ItemContainer #Summary #FreePurchase #PriceForFree
{
  color: Blue;
  float: left;
  font-weight: bold;
...
#ItemContainer #Summary #FreePurchase #BuyForFree
{
  float: left;
  line-height: 2em;
  width: 100px;
...
#ItemContainer #Summary #FreePurchase #BuyForFree .Button:hover
{
  background-color: #6e99c9;
  border: solid 1px #000;
}

#ItemContainer #Summary #FreePurchase #BuyForFree a:hover
{
    color: #fff;
}

#ItemContainer #Summary #GOLDBUXPurchase #PriceInGOLDBUX {
 color:Green;
 float:left;
 font-weight:bold;
 line-height:2em;
...
#ItemContainer #Summary #GOLDBUXPurchase #BuyWithGOLDBUX {
 float:left;
 line-height:2em;
 width:100px;
}
#ItemContainer #Summary #GOLDBUXPurchase #BuyWithGOLDBUX .Button:hover {
 background-color:#49b745;
 border:solid 1px #000;
}
#ItemContainer #Summary #GOLDBUXPurchase #BuyWithGOLDBUX a:hover {
 color:#fff;
}
...
#EditItemContainer .PricingField_GOLDBUX {
 float:left;
 margin-left:5px;
 text-align:left;
 width:110px;
...
#ItemContainer #GameConfiguration
{
 margin-top: 10px;
  background-color: #fff;
...
#SplashContainer #GOLDBLOXAtAGlance {
 background-color:#eee;
 border:solid 1px #000;
 float:right;
 margin:0 0 10px 0;
...
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo {
 color:#666;
 float:left;
 list-style:none;
 margin:0;
...
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo li {
 background-position:0 0;
 background-repeat:no-repeat;
 margin:0 0 25px 0;
 padding:0 0 0 56px;
}
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo h3 {
 line-height:1em;
 margin:0 0 5px 0;
 padding:0;
}
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo #Point1 {
 background-image:url(/images/BuildIcon.png);
}
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo #Point2 {
 background-image:url(/images/FriendsIcon.png);
}
#SplashContainer #GOLDBLOXAtAGlance #ThingsToDo #Point3 {
 background-image:url(http://www.rccs.lol/images/bullet3V3.png);
}
#SplashContainer #GOLDBLOXAtAGlance #Showcase {
 float:right;
 margin:0;
 width:400px;
}
#SplashContainer #GOLDBLOXAtAGlance #Install {
 clear:both;
 margin:5px 0 0 0;
 width:715px;
}
#SplashContainer #GOLDBLOXAtAGlance #ForParents {
 border:solid 1px #000;
 bottom:10px;
 height:125px;
 left:10px;
...
#SplashContainer #GOLDBLOXAtAGlance #PrivPolicy {
 bottom:10px;
 height:125px;
 left:140px;
 position:absolute;
...
#SplashContainer #GOLDBLOXAtAGlance #Install #CompatibilityNote {
 color:#666;
 float:left;
...
#SplashContainer #GOLDBLOXAtAGlance #Install #DownloadAndPlay {
 float:right;
 width:400px;
}
...
#SpecialMembershipOption #Lifetime {
 float:left;
 margin:0;
 padding:0 20px;
 width:214px;
...
#WhyJoin .MembershipBenefits .Benefit_MultiplePlaces {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/MultiplePlacesBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_GOLDBUXAllowance {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/AllowanceBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_SellContent {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/SellBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_SuppressAds {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/AdSuppressionBullet.png);
}
#WhyJoin .MembershipBenefits .Benefit_ExclusiveHat {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/HardHatBullet.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_OwnPlace {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletHouse.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_GetTix {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletTreasure.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_BuyStuff {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletShoppingBag.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_CustomizeGuy {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletWizardHat.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Username {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletStar.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Forums {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletScript.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Stats {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletStats.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Comments {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletPencil.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Badges {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletBadges.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_Friends {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletFriends.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_WeRock {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletCreative.png);
}
#WhyJoin #MembershipBenefits #SignupBenefit_OhYeahItsFree {
 background-image:url(/web/20090604133500im_/http://www.GOLDBLOX.com/images/JoinBulletHappy.png);
}
...
.ajax__tab_xp .ajax__tab_header {
    background-image: url(/images/AjaxTabs/Tabs.Line.gif)
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Right.gif)
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.Left.gif);
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Background.gif);
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_hover .ajax__tab_outer {
    /*! background-image: url(/images/AjaxTabs/Tabs.HoverRight.gif); */
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_hover .ajax__tab_inner {
    /*! background-image: url(/images/AjaxTabs/Tabs.HoverLeft.gif) */
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_hover .ajax__tab_tab {
    /*! background-image: url(/images/AjaxTabs/Tabs.Hover.gif); */
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_active .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.ActiveRight.gif);
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_active .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.ActiveLeft.gif);
}

.ajax__tab_xp .ajax__tab_header .ajax__tab_active .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Active.gif);
}
...
.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Right-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.Left-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_hover .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.HoverRight-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_hover .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.HoverLeft-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_hover .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Hover-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_active .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.ActiveRight-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_active .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.ActiveLeft-VerticalLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalleft .ajax__tab_active .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Active-VerticalLeft.gif)
}
...
.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Right-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.Left-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_hover .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.HoverRight-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_hover .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.HoverLeft-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_hover .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Hover-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_active .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.ActiveRight-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_active .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.ActiveLeft-VerticalRight.gif)
}

.ajax__tab_xp .ajax__tab_header_verticalright .ajax__tab_active .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Active-VerticalRight.gif)
}
...
.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-Right.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-Left.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Bottom.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_hover .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-HoverRight.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_hover .ajax__tab_inner {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-HoverLeft.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_hover .ajax__tab_tab {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-Hover.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_active .ajax__tab_outer {
    background-image: url(/images/AjaxTabs/Tabs.Bottom-ActiveRight.gif)
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_active .ajax__tab_inner {
    background-image: url('/images/AjaxTabs/Tabs.Bottom-ActiveLeft.gif"')
}

.ajax__tab_xp .ajax__tab_header_bottom .ajax__tab_active .ajax__tab_tab {
    background-image: url('/images/AjaxTabs/Tabs.Bottom-Active.gif"')
}
.ajax__tab_tab {
    color: #555!important
}
